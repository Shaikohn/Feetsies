        ...
        <div>
            ...
            <div className={styles.landing_container}>
                <div className="landing-title">
                    <h1 className={styles.landingTitle}>FEETSIES</h1>
                </div>
                <div className="landing-desc">
                    ...
                    <br></br>
                    <h3 className={styles.landingH3}>Our Mission</h3>
                    <p className={styles.landingP}>
                    ...
                    <h3 className={styles.landingH3}>Vision</h3>
                    <p className={styles.landingP}>
                    ...
                    <h3 className={styles.landingH3}>Support</h3>
                    <p className={styles.landingP}>
